...
/* Generated by nanopb-0.3.9 at Fri Jul 13 00:38:33 2018. */
...
#define _bwallet_cointype_t_MAX bwallet_cointype_t_ripple
#define _bwallet_cointype_t_ARRAYSIZE ((bwallet_cointype_t)(bwallet_cointype_t_ripple+1))
...
typedef enum _bwallet_command_t_ripple_t {
    bwallet_command_t_ripple_t_xrp_transaction_begin = 160,
    bwallet_command_t_ripple_t_xrp_transaction_update_data = 161,
    bwallet_command_t_ripple_t_xrp_transaction_finish = 163,
    bwallet_command_t_ripple_t_xrp_get_address = 176
} bwallet_command_t_ripple_t;
#define _bwallet_command_t_ripple_t_MIN bwallet_command_t_ripple_t_xrp_transaction_begin
