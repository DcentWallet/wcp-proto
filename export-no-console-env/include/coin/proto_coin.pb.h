...
/* Generated by nanopb-0.3.9 at Mon Apr 23 17:03:28 2018. */
...
/* Enum definitions */
typedef enum _coin_coin_group_t {
    coin_coin_group_t_none = 0,
    coin_coin_group_t_bitcoin = 1,
    coin_coin_group_t_btc_testnet = 2,
    coin_coin_group_t_ethereum = 3,
    coin_coin_group_t_ether_classic = 4,
    coin_coin_group_t_erc20 = 5,
    coin_coin_group_t_ripple = 6
} coin_coin_group_t;
#define _coin_coin_group_t_MIN coin_coin_group_t_none
#define _coin_coin_group_t_MAX coin_coin_group_t_ripple
#define _coin_coin_group_t_ARRAYSIZE ((coin_coin_group_t)(coin_coin_group_t_ripple+1))
...
#define coin_sync_account_info_req_parameter_t_init_default {0, 0, "", (coin_coin_group_t)0, "", "", "", ""}
#define coin_get_account_info_res_parameter_t_init_default {"", "", ""}
#define coin_extract_pubkey_req_parameter_t_init_default {false, "", ""}
#define coin_extract_pubkey_res_parameter_t_init_default {""}
#define coin_sync_account_info_req_parameter_t_init_zero {0, 0, "", (coin_coin_group_t)0, "", "", "", ""}
#define coin_get_account_info_res_parameter_t_init_zero {"", "", ""}
#define coin_extract_pubkey_req_parameter_t_init_zero {false, "", ""}
#define coin_extract_pubkey_res_parameter_t_init_zero {""}
...
extern const pb_field_t coin_get_account_info_res_parameter_t_fields[4];
...
#define coin_sync_account_info_req_parameter_t_size 114
#define coin_get_account_info_res_parameter_t_size 61
