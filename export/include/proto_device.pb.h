...
/* Generated by nanopb-0.3.9 at Wed Feb 28 19:49:14 2018. */
...
typedef struct _device_get_coin_info_req_parameter_t {
    uint32_t coin_start_idx;
    uint32_t coin_list_num;
/* @@protoc_insertion_point(struct:device_get_coin_info_req_parameter_t) */
} device_get_coin_info_req_parameter_t;
...
typedef struct _device_get_coin_info_res_parameter_t {
    pb_size_t coin_count;
    device_coin_list_t coin[10];
/* @@protoc_insertion_point(struct:device_get_coin_info_res_parameter_t) */
} device_get_coin_info_res_parameter_t;
...
#define device_get_info_res_parameter_t_init_default {"", "", "", (device_wallet_state_t)0, 0, device_fingerprint_t_init_default, ""}
#define device_get_coin_info_req_parameter_t_init_default {0, 0}
#define device_get_coin_info_res_parameter_t_init_default {0, {device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default, device_coin_list_t_init_default}}
...
#define device_get_info_res_parameter_t_init_zero {"", "", "", (device_wallet_state_t)0, 0, device_fingerprint_t_init_zero, ""}
#define device_get_coin_info_req_parameter_t_init_zero {0, 0}
#define device_get_coin_info_res_parameter_t_init_zero {0, {device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero, device_coin_list_t_init_zero}}
...
#define device_get_coin_info_req_parameter_t_coin_start_idx_tag 1
#define device_get_coin_info_req_parameter_t_coin_list_num_tag 2
#define device_set_label_req_parameter_t_label_tag 1
#define device_get_coin_info_res_parameter_t_coin_tag 5
...
#define device_get_info_res_parameter_t_coin_num_tag 5
...
extern const pb_field_t device_get_coin_info_req_parameter_t_fields[3];
extern const pb_field_t device_get_coin_info_res_parameter_t_fields[2];
...
#define device_get_info_res_parameter_t_size     102
#define device_get_coin_info_req_parameter_t_size 12
#define device_get_coin_info_res_parameter_t_size 130
#define device_set_label_req_parameter_t_size    13
#define device_fingerprint_t_size                12
#define device_coin_list_t_size                  11
